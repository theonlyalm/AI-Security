...
### 🔓 Phase 1: Discovery & Authentication Bypass
...
### 🔍 Phase 2: Enumerating Permissions
...
### 📥 Phase 3: Dumping the Database & Filesystem
...
Based on the **OWASP Top 10 for LLM Applications**, this vulnerability highlights the danger of "Excessive Agency"—giving an AI tool more permissions than necessary to perform its task.
